...
- model-display-name: 可以用空格连接, 例如 `"Audio Spectrogram Transformer"`, 对应于[文档页面](https://huggingface.co/docs/transformers/model_doc/audio-spectrogram-transformer)上的模型名称
