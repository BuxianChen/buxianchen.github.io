...
for block in self.h:
    ...
    # block.attn: QWenAttention: (TODO: 确认具体操作)
    attn_outputs = block.attn(layernorm_output, rotary_pos_emb)
    # (TODO) attn_output: (B, L, num_heads, head_dim)
...
Qwen 采用了 RoPE 位置编码, 并在推理时应用了外推技术(参考文献TODO):
