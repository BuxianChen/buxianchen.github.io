...
async def app(scope, receive, send):
    ...
    print("SCOPE:")
    print(scope)
    print("receive function/corotine:")
    print(receive)
    print("send function/corotine:")
    print(send)
...
==== APP CALLED ====
SCOPE:
{'type': 'http', 'asgi': {'version': '3.0', 'spec_version': '2.3'}, 'http_version': '1.1', 'server': ('127.0.0.1', 8000), 'client': ('127.0.0.1', 41828), 'scheme': 'http', 'root_path': '', 'headers': [(b'host', b'127.0.0.1:8000'), (b'user-agent', b'python-requests/2.32.5'), (b'accept-encoding', b'gzip, deflate'), (b'accept', b'*/*'), (b'connection', b'keep-alive'), (b'content-length', b'39'), (b'content-type', b'application/json')], 'state': {}, 'method': 'POST', 'path': '/test', 'raw_path': b'/test', 'query_string': b''}
receive function/corotine:
<bound method RequestResponseCycle.receive of <uvicorn.protocols.http.httptools_impl.RequestResponseCycle object at 0x75f9e38dbe60>>
send function/corotine:
<bound method RequestResponseCycle.send of <uvicorn.protocols.http.httptools_impl.RequestResponseCycle object at 0x75f9e38dbe60>>

RECEIVE EVENT:
{'type': 'http.request', 'body': b'{"name": "buxian", "msg": "hello asgi"}', 'more_body': False}

FULL BODY: b'{"name": "buxian", "msg": "hello asgi"}'
...
# 客户端日志:
STATUS: 200
BODY: {"method": "POST", "path": "/test", "body": "{\"name\": \"buxian\", \"msg\": \"hello asgi\"}"}
```
