...
本节主要实现一个 WSGI server (对标 gunicorn) 与 WSGI application framework (对标 Flask).
...
def app(environ, start_response):
    ...
    start_response(status, headers=response_headers)  # start_response: gunicorn.http.wsgi.Response
